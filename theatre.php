    ...
    <div class="theatre">
        ...
        <div class="container mt-4" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="theatre_image">
                        <img src="data:image/jpeg;base64,<?php echo base64_encode($row_theatre['image'])?>"
                            class="theatre_image">
                    </div>
                </div>
                <div class="wrp col-sm-4">
                    ...
                    <table class="theatre_details">
                        ...
                        <tr>
                            <td>Số điện thoại: </td>
                            <td><a
                                    href="tel:+94<?php echo $row_theatre['telephone']?>">+94<?php echo $row_theatre['telephone']?></a>
                            </td>
                        </tr>
                        <tr height="10"></tr>
                        <tr>
                            <td>Email:</td>
                            <td><a
                                    href="mailto:<?php echo $row_theatre['email']?>"><?php echo $row_theatre['email']?></a>
                            </td>
                        </tr>
                        <tr height="10"></tr>
                    </table>
                    <h4 style="color:#3f3545; font-size:20px; line-height:30px;">Cơ sở</h4>
            ...
            <div class="nowshowing_movies">
                <h4
                    style="font-weight:normal; color: #3f3545; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-size:36px; margin-bottom:30px; padding-top:15px">
                    Phim đang chiếu tại <?php echo $row_theatre['theatre_name']?></h4>
                <div class="row">
                    <?php while($row_nowshowing = mysqli_fetch_array($result_nowshowing)){ ?>
                    <div class="col-md-3 col-sm-4">
                        <div class="movie">
                            <a href="movie.php?movie_id=<?php echo $row_nowshowing['movie_id']; ?>"><img
                                    src="data:image/jpeg;base64,<?php echo base64_encode($row_nowshowing['poster'])?>"
                                    class="movie_image"></a>
                            <div class="movie_bottom_wrap">
                                <a href="movie.php?movie_id=<?php echo $row_nowshowing['movie_id']; ?>"
                                    class="movie_name">
                                    <h6><?php echo $row_nowshowing['movie_name']?></h6>
                                </a>
                                <a href="buy_tickets.php?movieID=<?php echo $row_nowshowing['movie_id'];?>"
                                    class="btn btn-danger" style="width:100%; font-size: 18px;">Mua Vé</a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
            ...
            <div class="nowshowing_movies">
                <h4
                    style="font-weight:normal; color: #3f3545; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-size:36px; margin-bottom:30px; padding-top:15px">
                    Phim sắp chiếu tại <?php echo $row_theatre['theatre_name']?></h4>
                <div class="row">
                    <?php while($row_upcoming = mysqli_fetch_array($result_upcoming)){ ?>
                    <div class="col-md-3 col-sm-4">
                        <div class="movie">
                            <a href="movie.php?movie_id=<?php echo $row_upcoming['movie_id']; ?>"><img
                                    src="data:image/jpeg;base64,<?php echo base64_encode($row_upcoming['poster'])?>"
                                    class="movie_image"></a>
                            <div class="movie_bottom_wrap">
                                <a href="movie.php?movie_id=<?php echo $row_upcoming['movie_id']; ?>"
                                    class="movie_name">
                                    <h6><?php echo $row_upcoming['movie_name']?></h6>
                                </a>
                                <a href="buy_tickets.php?movieID=<?php echo $row_upcoming['movie_id'];?>"
                                    class="btn btn-danger" style="width:100%; font-size: 18px;">Mua vé</a>
                            </div>
                        </div>
                    </div>
