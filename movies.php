								...
								<div class="col-md-3 col-sm-4">
									<div class="movie">
										...
										<div class="movie_bottom_wrap">
											...
											<a href="buy_tickets.php?movieID=<?php echo $row_nowshowing['movie_id'];?>" class="btn btn-danger" style="width:100%; font-size: 18px;">Đặt vé</a>
										</div>
								...
								<div class="col-md-3 col-sm-4">
									<div class="movie">
										...
										<div class="movie_bottom_wrap">
											...
											?>
											<a href="buy_tickets.php?movieID=<?php echo $row_upcoming['movie_id'];?>" class="btn btn-danger" style="width:100%; font-size: 18px;">Đặt vé</a>
											<?php
											}else if($row_upcoming['status']=='0'){
											?>
												<button class="btn btn-danger" style="width:100%; font-size: 18px;" disabled>Vé Không có sẵn!</button>
											<?php } ?>
										</div>
									</div>
								</div>
