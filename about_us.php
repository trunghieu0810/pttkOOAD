  ...
  <body>
    ...
    <div class="about_us">
        ...
        <div class="container mt-4" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif">
            <h2 style="font-weight:normal; color: #3f3545; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-size:48px; margin-bottom:30px; padding-top:15px">Về chúng tôi</h2>
            
            <div><p style="font-size: 18px;"><strong>Tổng quan dự án</strong></p>
                 <p>Trang web này đang trong quá trình mô phỏng. Không chấp nhận thanh toán, hoàn lại tiền hoặc đặt vé thực tế tại rạp.</p>
                 <p>Thiết kế và tính năng cơ bản của trang web này được lấy cảm hứng từ thiết kế và tính năng của trang web chính thức của EAP Films và Rạp chiếu phim tức là <a href="http://www.eapmovies.com">www.eapmovies.com</a>.</p>
                 <p>&nbsp;</p>
                 ...
                 <p class="indent">Bạn có thể xem các bộ phim, rạp chiếu phim và ưu đãi hiện có trên các trang có liên quan của Cinema.</p>
                 <p class="double_indent">Bạn có thể xem giá vé và lịch chiếu của mỗi bộ phim tại các rạp khác nhau trong trang Giá và Giờ chiếu của Cinema.</p>
