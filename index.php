                        ...
                        <div class="item">
                            <div class="card">
                                <a href="movie.php?movie_id=<?php echo $row_nowshowing['movie_id'];?>"><img
                                        src="<?php echo 'data:image/jpeg;base64,'.base64_encode($row_nowshowing['poster']);?>"
                                        alt="img" class="card-img-top"></a>
                                <div class="card-body">
                                    <a class="movie_name"
                                        href="movie.php?movie_id=<?php echo $row_nowshowing['movie_id'];?>">
                                        <h5><?php echo $row_nowshowing['movie_name'] ?></h5>
                                    </a>
                                    <a class="btn btn-booking btn-danger"
                                        href="buy_tickets.php?movieID=<?php echo $row_nowshowing['movie_id'] ?>">Mua
                                        Vé</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="card">
                                <a href="movie.php?movie_id=<?php echo $row_upcoming['movie_id'];?>"><img
                                        src="<?php echo 'data:image/jpeg;base64,'.base64_encode($row_upcoming['poster']) ?>"
                                        alt="img" class="card-img-top"></a>
                                <div class="card-body">
                                    <a class="movie_name"
                                        href="movie.php?movie_id=<?php echo $row_upcoming['movie_id'];?>">
                                        <h5><?php echo $row_upcoming['movie_name'] ?></h5>
                                    </a>
                                    <a class="btn btn-booking btn-danger <?php if($row_upcoming['status']==0){echo 'disabled';} ?>"
                                        <?php if($row_upcoming['status']=='1'){echo 'href="buy_tickets.php?movieID='.$row_upcoming['movie_id'].'"';}?>><?php if($row_upcoming['status']==0){echo 'Vé không có sẵn!';}else{echo 'Buy Tickets';} ?></a>
                                </div>
                            </div>
                        </div>
