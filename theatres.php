...
<body>
    ...
    <div class="theatres">
        ...
        <div class="container mt-4" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif">
            ...
            <div class="theatres">
                <h2
                    style="font-weight:normal; color:#23241d; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-size:45px; margin-bottom:30px; padding-top:15px">
                    Các rạp chiếu phim</h2>
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="theatre">
                            ...
                            <div class="theatre_bottom_wrap">
                                <h6 class="theatre_name">
                                    <?php echo $row_theatres['theatre_name'].' - '.$row_theatres['city'] ?></h6>
                                <table class="theatre_details">
                                    ...
                                    <tr>
                                        <td>Số điện thoại: </td>
                                        <td><a
                                                href="tel:+94<?php echo $row_theatres['telephone']?>">+94<?php echo $row_theatres['telephone']?></a>
                                        </td>
                                    </tr>
                                    <tr height="10"></tr>
                                    <tr>
                                        <td>Email:</td>
                                        <td><a
                                                href="mailto:<?php echo $row_theatres['email']?>"><?php echo $row_theatres['email']?></a>
                                        </td>
                                    </tr>
                                    <tr height="10"></tr>
                                </table>
                                ...
                                <div class="ratings_wrap">
                                    <div class="rating <?php echo $class; ?>"
                                        id="<?php echo $row_theatres['avg_ratings']; ?>_<?php echo $row_theatres['theatre_id']; ?>">
                                    </div>
                                </div>

                                <a href="theatre.php?theatre_id=<?php echo $row_theatres['theatre_id'];?>"
