    ...
    <div class="change_password" style="padding-bottom:40px;">
      ...
      <div class="container mt-4" style="font-size: 14px; color: #606978; font-family:sans-serif">
        ...
        <form  class="change_password-page" method="POST" onSubmit = "return checkPassword(this)">
          ...
          <div class="form-group row">
            <label class="col-sm-5 col-form-label">Xác nhận mật khẩu mới: <span style="color:red">*</span></label>
            <div class="col-sm-7">
          ...
          <div style="text-align:center">
            <button class="btn btn-danger btn-block" style="align-self:center" type="submit" name="change_password">Đổi mật khẩu</button>
          </div>
