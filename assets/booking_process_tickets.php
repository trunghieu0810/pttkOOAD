            ...
            <div class="container-fluid" align="center">
                ...
                <div class="form_area col-md-6 col-md-offset-3">
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-4">
                            <label>Tổng vé</label>
                            <div class="ticket_count" id="total_ticket_count">
                                <!--Total Ticket Count Value-->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                            <button class="btn btn-primary firstbtn" type="button">Tiếp tục</button>
                        </div>
                    </div>
        ...
        jQuery(".firstbtn").on('click', function() {
            if (totalTicketCount > 0) {
                $.ajax({
                    ...
                    data: 'fullTicketCount=' + fullTicketCount + '&kidsTicketCount=' +
                        kidsTicketCount + '&totalTicketCount=' + totalTicketCount,
                    beforeSend: function() {
                        $(".loader").fadeIn(300);
                    },
                ...
                $.toast({
                    text: "Chọn ít nhất 1 để tiếp tục.",
                    icon: 'error',
                    position: 'top-center',
                    hideAfter: 3000,
                    stack: false,
