                        ...
                        <table id="table" class="table table-striped table-bordered table-sm">
                            ...
                            $i+=1; ?>
                                <tr>
                                    ...
                                    <td><?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['poster']).'" style="height:25%; width: 100px;"/>'; ?>
                                    </td>
                                    <td><?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['banner']).'" style="height:25%; width: 260px;"/>'; ?>
                                    </td>
                                    <td><?php
                                    if ($row['status']=="0"){
                                        echo "Inactive";
                                ...
                                ?></td>
                                    ...
                                    <td id='action_column'><a
                                            href="assets/movies.delete.php?movie_id=<?php echo $row['movie_id']; ?>"><button
