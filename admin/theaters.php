...
<body class="grey lighten-4">
    ...
    <main class="pt-5 mx-lg-5">
        <div class="container-fluid mt-5">
            ...
            <!-- Editable table -->
            <div class="card">
                <h3 class="card-header text-center font-weight-bold text-uppercase py-3">Rạp</h3>
                <div class="card-body">
                    <div class="add_new_theater">
                        <a href="theaters.add.php"><button type="button" class="add_button">Thêm Rạp</button></a>
                    </div>
                    <br>
                        ...
                        <table id="table" class="table table-striped table-bordered table-sm">
                            ...
                            $i+=1; ?>
                                <tr>
                                    ...
                                    <td><?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['image']).'" style="height:30%; width: 260px"/>'; ?>
                                    </td>
                                    ...
                                    <td id='action_column'><a
                                            href="assets/theaters.delete.php?theatre_id=<?php echo $row['theatre_id']; ?>"><button
