...
<body class="grey lighten-4">
  ...
  <main class="pt-5 mx-lg-5">
    <div class="container-fluid mt-5">
        ...
        <!-- Editable table -->
        <div class="card">
            <h3 class="card-header text-center font-weight-bold text-uppercase py-3">Thời gian chiếu</h3>
            <div class="card-body">
                <div class="add_new_showtime">
                    <button type="button" class="add_button" data-toggle="modal" data-target="#addShowtimeModal">Thêm Thời Gian chiếu</button>
                </div>
        ...
        aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="addShowtimeModalLongTitle">Lịch Chiếu Phim Mới</h5>
                ...
                <div class="modal-body">
                    <form id="add_showtime_form">
                        <div class="form-group row">
                            <label for="show_label" class="col-sm-3 col-form-label">Hiển Thị:</label>
                            <div class="col-sm-9">
                        ...
                        <div id="showtimes_div">
                            <div class="form-group row">
                                <label for="showtime_label" class="col-sm-3 col-form-label">Thời Gian:</label>
                                <div class="col-sm-9">
        ...
        aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLongTitle">Cập Nhật Lịch Chiếu phim mới</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                            <label for="show_update_label" class="col-sm-3 col-form-label">Hiển thị:</label>
                            <div class="col-sm-9">
                        ...
                        <div id="showtimes_update_div">
                            <div class="form-group row">
                                <label for="showtime_update_label" class="col-sm-3 col-form-label">Thời gian(s):</label>
                                <div class="col-sm-9">
        ...
        <div class="modal fade" id="deleteShowtimeModal" tabindex="-1" role="dialog" aria-labelledby="deleteShowtimeModalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-body">
                Bạn có chắc chắn muốn xóa các lịch chiếu phim này không?
