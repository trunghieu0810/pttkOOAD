...
<body class="grey lighten-4">
    ...
    <main class="pt-5 mx-lg-5">
        <div class="container-fluid mt-5">
            ...
            <!-- Editable table -->
            <div class="card">
                <h3 class="card-header text-center font-weight-bold text-uppercase py-3">Giờ chiếu phim</h3>
                <div class="card-body">
                    <div class="add_new_showtime">
                        <button type="button" class="add_button" data-toggle="modal"
                            data-target="#addShowtimeModal">Thêm Giờ Chiếu</button>
                    </div>
            ...
            <div class="modal fade" id="addShowtimeModal" tabindex="-1" role="dialog"
                aria-labelledby="addShowtimeModalTitle" aria-hidden="true">
                <!-- Add .modal-dialog-centered to .modal-dialog to vertically center the modal -->
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addShowtimeModalLongTitle">Thêm Giờ Chiếu Phim Mới</h5>
                        ...
                        <div class="modal-body">
                            <form id="add_showtime_form">
                                <div class="form-group row">
                                    <label for="show_label" class="col-sm-3 col-form-label">Chọn:</label>
                                    <div class="col-sm-9">
                                ...
                                <div id="showtimes_div">
                                    <div class="form-group row">
                                        <label for="showtime_label" class="col-sm-3 col-form-label">Giờ chiếu:</label>
                                        <div class="col-sm-9">
                                            <table id="showtimes_input_table_initial_fixed">
                                                <tr>
                                                    <td>
                                                        <input type="text" width="296px" id="showtime" name="showtime[]"
                                                            class="form-control" placeholder="Thêm giờ chiếu"
                                                            onfocus="this.blur()" required="required">
                                                    </td>
                                                    <td>
                                                        <button type="button" id="add_time" style="margin-left: 7px;"><i
            ...
            <div class="modal fade" id="updateShowtimeModal" tabindex="-1" role="dialog"
                aria-labelledby="updateShowtimeModalTitle" aria-hidden="true">
                <!-- Add .modal-dialog-centered to .modal-dialog to vertically center the modal -->
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="updateModalLongTitle">Chỉnh sửa giờ chiếu phim</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        ...
                        <div class="modal-body">
                            <form id="update_showtime_form">
                                <div class="form-group row">
                                    <label for="show_update_label" class="col-sm-3 col-form-label">Phim | Rạp:</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="show_update" name="show_update" class="form-control"
                                            disabled="disabled">
                                    </div>
                                </div>
                                ...
                                <div id="showtimes_update_div">
                                    <div class="form-group row">
                                        <label for="showtime_update_label" class="col-sm-3 col-form-label">Giờ
                                            chiếu:</label>
                                        <div class="col-sm-9">
            ...
            <div class="modal fade" id="deleteShowtimeModal" tabindex="-1" role="dialog"
                aria-labelledby="deleteShowtimeModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="deleteShowtimeModalLongTitle">Cập Nhật</h5>
                        </div>
                        <div class="modal-body">
                            Bạn có chắc chắn muốn xóa các giờ chiếu phim này không?
    ...
    $(document).ready(function() {
        ...
        $(".gj-timepicker").children('.input-group-append').children('button').removeClass(
            "btn btn-secondary btn-outline-secondary border-left-0");
        ...
        $("#add_time").click(function() {
            ...
            $("#showtimes_input_table").append(
                '<tr><td style="padding-top:12px;"><input type="text" width="296px" id="showtime' +
                i +
                '" name="showtime[]" class="form-control" placeholder="Select Time" onfocus="this.blur()" required="required"></td><td style="padding-top:12px;"><button type="button" id="delete_time" style="margin-left: 7px;"><i class="fas fa-minus fa-2x"></i></button></td></tr>'
                )
        ...
        $(document).on("click", ".edit_button", function() {
            ...
            for (var x = 0; x < showtimeCount; x++) {
                var time = row.closest("tr").find("td:eq(4)").children("table").find("tr:eq(" + x + ")")
                    .children("td").text();
                var st_id = row.closest("tr").find("td:eq(4)").children("table").find("tr:eq(" + x +
                    ")").children("td").attr("showtimeID");
                st_array.push(st_id);
                $("#showtimes_update_table").append(
                    '<tr><td style="padding-bottom:12px;"><input type="text" id="showtime_update' +
                    x + '" name="showtime_update[]" value="' + time +
                    '" class="form-control" placeholder="Select Time" onfocus="this.blur()"></td>')
        ...
        $("#update").click(function() {
            ...
            $.ajax({
                ...
                type: "post",
                data: $("#update_showtime_form").serialize() + "&showtimeID_update=" +
                    showtimeID_update_Encoded,
                success: function() {
