                ...
                <div class="modal-body">
                    <form id="add_seat_category_form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group row col-md-6">
                                <label for="num_of_cols_label" class="col-sm-5 col-form-label">Số dãy ghế:</label>
                                <div class="col-sm-7">
                    ...
                    <form id="view_seat_category_form">
                        <div class="form-row">
                            ...
                            <div class="form-group row col-md-4">
                                <label for="seat_category_view_label" class="col-sm-5 col-form-label">Hạng ghế:</label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group row col-md-3">
                                <label for="num_of_seats_view_label" class="col-sm-6 col-form-label">Số chỗ ngồi:</label>
                                <div class="col-sm-6">
