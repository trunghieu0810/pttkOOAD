...
<body class="grey lighten-4">
    ...
    <main class="pt-5 mx-lg-5">
        <div class="container-fluid mt-5">
                ...
                <div class="card-body">
                    <div class="add_new_seat_category">
                        <button type="button" class="add_button" data-toggle="modal"
                            data-target="#addSeatCategoryModal">Thêm sơ đồ mới</button>
                    </div>
            ...
            <div class="modal fade" id="addSeatCategoryModal" tabindex="-1" role="dialog"
                aria-labelledby="addSeatCategoryModalTitle" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <form id="add_seat_category_form">
                                <div class="form-row">
                                    ...
                                    <div class="form-group row col-md-6">
                                        <label for="num_of_rows_label" class="col-sm-5 col-form-label">Số hàng
                                            ghế:</label>
                                        <div class="col-sm-7">
                                            <select id="num_of_rows" name="num_of_rows" class="form-control"
                                                required="required">
                                ...
                                <div class="form-row">
                                    <div class="form-group row col-md-6">
                                        <label for="seat_category_label" class="col-sm-3 col-form-label">Phòng
                                            chiếu</label>
                                        <div class="col-sm-9">
                                            <select id="seat_category" name="seat_category" class="form-control"
                                                required="required">
                                    ...
                                    <div class="form-group row col-md-6">
                                        <label for="num_of_cols_label" class="col-sm-5 col-form-label">Số dãy
                                            ghế:</label>
                                        <div class="col-sm-7">
                                            <select id="num_of_cols" name="num_of_cols" class="form-control"
                                                required="required">
                                                <option value="" disabled selected>Chọn số dãy ghế</option>
                                                <?php
                                            for ($c = 1; $c <= 35; $c++)
                                            {
                                ...
                                <div id="form_submission" align="center">
                                    <button type="button" id="proceed_button">Tiếp tục</button>
                                </div>
                            </form>
            ...
            <div class="modal fade" id="viewSeatMapModal" tabindex="-1" role="dialog"
                aria-labelledby="viewSeatMapModalTitle" aria-hidden="true">
                <!-- Add .modal-dialog-centered to .modal-dialog to vertically center the modal -->
                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                    <div class="modal-content">
                            ...
                            <form id="view_seat_category_form">
                                <div class="form-row">
                                    ...
                                    <div class="form-group row col-md-5">
                                        <label for="theater_view_label" class="col-sm-3 col-form-label">Rạp:</label>
                                        <div class="col-sm-9">
                                            <input type="text" id="theater_view" name="theater_view"
                                                class="form-control" style="text-align:center;" disabled="disabled">
                                        </div>
                                    </div>

                                    <div class="form-group row col-md-4">
                                        <label for="seat_category_view_label" class="col-sm-5 col-form-label">Hạng
                                            ghế:</label>
                                        <div class="col-sm-7">
                                            <input type="text" id="seat_category_view" name="seat_category_view"
                                                class="form-control" style="text-align:center;" disabled="disabled">
                                        </div>
                                    </div>

                                    <div class="form-group row col-md-3">
                                        <label for="num_of_seats_view_label" class="col-sm-6 col-form-label">Số chỗ
                                            ngồi:</label>
                                        <div class="col-sm-6">
                                            <input type="text" id="num_of_seats_view" name="num_of_seats_view"
                                                class="form-control" style="text-align:center;" disabled="disabled">
                                        </div>
                                    </div>
            ...
            <div class="modal fade" id="deleteSeatCategoryModal" tabindex="-1" role="dialog"
                aria-labelledby="deleteSeatCategoryModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="deleteSeatCategoryModalLongTitle">Cập Nhật</h5>
                        </div>
                        <div class="modal-body">
                            Bạn có chắc chắn muốn xóa danh mục ghế rạp này không?
    ...
    $(document).ready(function() {
        ...
        $("#save").click(function() {
            ...
            var ajaxData = $("#add_seat_category_form").serialize() + "&category_name=" + $(
                    "#seat_category option:selected").text() + "&seatsArray=" + seatsArrayEncoded +
