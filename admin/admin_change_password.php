        ...
        <div>
            <form class="signup-page" method="POST" onSubmit="return checkPassword(this)">
                ...
                <div class="form-group row">
                    ...
                    <input class="form-control col-sm-7" type="password" name="cur_password" id="cur_password"
                        pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                ...
                <div class="form-group row">
                    ...
                    <input class="form-control col-sm-7" type="password" name="new_password1" id="new_password1"
                        pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                        title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
                        required>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <input class="form-control col-sm-7" type="password" name="new_password2" id="new_password2"
                        pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                        title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
                        required>
                </div>
                ...
                <div class=" row">
                    ...
                    <div class="button" style="text-align:center">
                        <button class="btn btn-danger" style="align-self:center" type="submit"
                            name="change_password">Đồng ý</button>
                    </div>
                </div>
            </form>
