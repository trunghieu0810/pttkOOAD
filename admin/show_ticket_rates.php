...
<body class="grey lighten-4">
    ...
    <main class="pt-5 mx-lg-5">
        <div class="container-fluid mt-5">
            ...
            <!-- Editable table -->
            <div class="card">
                <h3 class="card-header text-center font-weight-bold text-uppercase py-3">Giá vé</h3>
                <div class="card-body">
                    <div class="add_show_ticket_rate">
                        <button type="button" class="add_button" data-toggle="modal"
                            data-target="#addShowTicketRateModal">Thêm Giá vé</button>
                    </div>
            ...
            <div class="modal fade" id="addShowTicketRateModal" tabindex="-1" role="dialog"
                aria-labelledby="addShowTicketRateModalTitle" aria-hidden="true">
                <!-- Add .modal-dialog-centered to .modal-dialog to vertically center the modal -->
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addShowTicketRateModalLongTitle">Thêm Giá vé</h5>
            ...
            <div class="modal fade" id="deleteShowTicketRateModal" tabindex="-1" role="dialog"
                aria-labelledby="deleteShowTicketRateModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="deleteShowTicketRateModalLongTitle">Hoàn Tất</h5>
                        </div>
                        <div class="modal-body">
