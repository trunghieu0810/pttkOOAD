      ...
      <form class="signup-page" method="POST">
        <h2 style="font-weight:400; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; color: white; font-size:48px; margin-bottom:30px; padding-top:15px; border-bottom: 1px solid #FFF; text-align:center; padding-bottom: 15px;">Register</h2>
          ...
          <div class="form-group row">
            <label class="col-sm-4 col-form-label" style="">Họ và tên đệm: <span style="color:red">*</span> </label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
              <label class="col-sm-4 col-form-label" style="">Tên: <span style="color:red">*</span> </label>
              <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="col-sm-4 col-form-label" style="">Số điện thoại:</label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="col-sm-4 col-form-label" style="">Email: <span style="color:red">*</span></label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="col-sm-4 col-form-label" style="">Tên Sử Dụng: <span style="color:red">*</span></label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="col-sm-4 col-form-label" style="">Mật khẩu: <span style="color:red">*</span></label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="col-sm-4 col-form-label" style="">Xác nhận mật khẩu: <span style="color:red">*</span></label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="col-sm-4 col-form-label" style="">Mã xác nhận: <span style="color:red">*</span></label>
            <div class="col-sm-8">
          ...
          <div style="margin-bottom:15px; text-align:center">
              <input type="checkbox" style="margin-right:10px" required>Đồng ý <a class="terms" href="terms_and_conditions.php" style="text-decoration:none;">Terms and Conditions</a>
          </div>
          ...
          <div style="margin:30px 0;">
            <a style="text-decoration:none;color:red" href="admin.login.php">Đăng nhập</a>
          </div>
