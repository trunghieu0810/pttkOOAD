...
<body class="grey lighten-4">
    ...
    <main class="pt-5 mx-lg-5">
        <div class="container-fluid mt-5">
                ...
                <div class="card-body">
                    <div class="add_new_carousel_image">
                        <button type="button" class="add_button" data-toggle="modal"
                            data-target="#addCarouselImageModal">Add New Carousel Image</button>
                    </div>
            ...
            <div class="modal fade" id="addCarouselImageModal" tabindex="-1" role="dialog"
                aria-labelledby="addCarouselImageModalTitle" aria-hidden="true">
            ...
            <div class="modal fade" id="deleteCarouselImageModal" tabindex="-1" role="dialog"
                aria-labelledby="deleteCarouselImageModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
