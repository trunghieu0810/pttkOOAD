                ...
                <div class="content"
                    ...
                    <form id="add_form" method="post" enctype="multipart/form-data">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type='text' class="form-control" type="text" name="theatre_name"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type='text' class="form-control" type="text" name="city"
                                    title="Three or more letter" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type='text' class="form-control" type="text" name="address"
                                    title="Three or more letter" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type='text' class="form-control" type="text" name="telephone" pattern="[0-9]{10}"
                                    title="only 10 digit number" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type='text' class="form-control" type="text" name="email"
                                    ...
                                    title="The format should be user@something.xxx" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="label" class="col-sm-3 col-form-label">Mô tả</label>
                            <div class="col-sm-9">
                                <input type='textbox' class="form-control" type="text" name="description"
                                    title="include description" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="label" class="col-sm-3 col-form-label">Hình ảnh</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type='text' class="form-control" type="text" name="Facilities"
                                    title="include the facilities available" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="content-footer" align="center">
                            ...
                            <button onclick="location.href='theaters.php'" class="btn btn-secondary">Hủy</button>
                        </div>
                    </form>
                </div>
            </div>
