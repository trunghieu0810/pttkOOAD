    ...
    <header>
        ...
        <div class="sidebar-fixed position-fixed">
            ...
            <div class="logo-wrapper-custom">
                <img src="images/logo.png" width="30px" height="30px" class="img-fluid" alt="Cinema Private Limited">
                Cinema
            </div>

            <div class="list-group list-group-flush">
                <a href="dashboard.php" class="list-group-item">
                    <i class="fas fa-chart-pie mr-3"></i>Điều Khiển</a>
                <a href="profile.php" class="list-group-item active">
                    <i class="fas fa-user mr-3"></i>Hồ Sơ</a>
                <a href="movies.php" class="list-group-item">
                    <i class="fas fa-film mr-3"></i>Phim</a>
                <a href="theaters.php" class="list-group-item">
                    <i class="fas fa-building mr-3"></i>Rạp</a>
                ...
                <a href="refunds.php" class="list-group-item">
                    <i class="fas fa-images mr-3"></i>Hoàn tiền</a>
            </div>
