  ...
  <body>
    ...
    <div class="offer" style="padding-bottom:15px;">
        ...
        <div class="container mt-4" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif">
            ...
            <div class="wrp">
                <h4>Ngày chiếu</h4><h6><?php echo $row_offer['start_date']?></h6><br>
                <h4>Kết thúc</h4><h6><?php echo $row_offer['end_date']?></h6><br>
                <h4>Mô tả</h4><h6 style="line-height:25px"><?php echo nl2br($row_offer['description'])?></h6>
            </div>
