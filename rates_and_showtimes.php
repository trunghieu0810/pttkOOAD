        ...
        <div class="container mt-4">
            ...
            <form class="form_details mt-4" action="request.php" id="detailsFrm" name="frmName" method="POST">
                <div class="form-group row">
                    <label for="inputMovie" class="col-sm-2 col-form-label">Phim</label>
                    <div class="col-sm-10">
            ...
            <div class="output_details" id="output_details" style="display:none;">
                ...
                <button id="buy_tickets_btn" class="btn btn-danger mt-4">Đặt vé</button>
            </div>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery("#detailsFrm").submit(function(e) {
            ...
            if (movieID != '', selectedDate != '', theatreID != '') {
                ...
                jQuery.ajax({
                    type: 'POST',
                    data: 'action=submitForm&movie_id=' + movieID + '&selected_date=' +
                        selectedDate + '&theatre_id=' + theatreID,
