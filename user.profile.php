  ...
  <body id="itemid-3" style="background-color:#ebebeb">
    ...
    <div style="margin-top:100px;margin-bottom:25px; min-height:392px">
        <div class="container mt-3" style="background:#FFF;padding-bottom:15px; max-width:800px">
            <div style="padding:15px"><h1 style="font-size:35px; font-weight:normal;">Hồ sơ</h1></div>
            ...
            <form id="user_profile_details" style="margin:10px 15px 0">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <a class="btn btn-warning" href="user.change_password.php" style="font-weight:500; width:100%; box-shadow:none">Đổi mật khẩu</a>
                    </div>
                </div>
                <div class="form-group row">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editUserProfileModalLongTitle">Cập nhật hồ sơ</h5>
    ...
    <div class="modal fade" id="deleteAccountModal" tabindex="-1" role="dialog" aria-labelledby="deleteAccountModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteAccountModalLongTitle">Xác nhận</h5>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn" id="close_delete" data-dismiss="modal">Không</button>
                <button type="button" class="btn" id="delete_confirm">Có</button>
            </div>
            </div>
        </div>
    </div>
