    ...
    <div class="login" style="padding-bottom:40px">
        ...
        <div class="container mt-4" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif">
            ...
            <form class="login-page" method="POST">
                <h2
                    style="font-weight:400; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; color: #3f3545; font-size:48px; margin-bottom:30px; padding-top:15px; border-bottom: 1px solid #333333; text-align:center; padding-bottom: 15px;">
                    Đăng Nhập</h2>
                ...
                <div style="text-align:center;">
                    <button class="btn btn-danger btn-lg" type="submit" name="login" style="padding:7px 20px">Đăng
                        Nhập</button>
                </div>
                ...
                <div style="margin:30px 0 0 0;">
                    <a style="text-decoration:none;color:red" href="login.forgot_password.php">Quên mật khẩu?</a>
                    <br />
                    <a style="text-decoration:none;color:red" href="register.php">Đăng kí</a>
                </div>
