								...
								<div class="contact_form_area" style="max-width:445px;text-align:left">
									<form id="contactForm" method="post">
											...
											<div class="form-group" style="margin-top:30px;text-align:center">  
												<button type="reset" class="btn btn-secondary btn-lg cancel-btn">Làm mới</button>
												<button type="submit" name="submit" class="btn btn-danger btn-lg btn-submit">Gửi</button>
											</div>
									</form>
								</div>
							</div>
